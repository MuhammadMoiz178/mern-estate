        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <div className='flex flex-col flex-1'>
                ...
                <div className='flex gap-4'>
                    <input className='border border-gray-300 rounded w-full' type="file" id='images' accept='image/*' multiple />
                    <button className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>
                    Upload</button>
                </div>
                 <button className='p-3 mt-2 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95'>Create Listing</button>
            </div>
            </form>
        </main>
    )
